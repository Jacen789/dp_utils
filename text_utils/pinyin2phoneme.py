...
def main():
    ...
    for pinyin in PINYIN_DICT:
        phonemes = PINYIN_DICT[pinyin]
        phoneme_str = " ".join(phonemes)
        phoneme_str = phoneme_str.lstrip("^ ")
        phoneme_str2 = pinyin2phoneme(pinyin)
        if phoneme_str != phoneme_str2:
            print(pinyin, phoneme_str, phoneme_str2)
